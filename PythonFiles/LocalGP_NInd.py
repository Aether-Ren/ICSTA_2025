...
output_file = 'Result/LocalGP_preds_MSE_NInd.csv'


if not os.path.exists(output_file):
    with open(output_file, 'w') as f:
        f.write('Iteration,MSE_LocalGP,MSE_estimated_LocalGP,func_loss\n')
...
for i in range(50):
    ...
    Mean_loss = np.mean(full_test_estimated_params_LocalGP_loss)

    with open(output_file, 'a') as f:
        f.write(f"{i + 1},{MSE_LocalGP},{MSE_estimated_LocalGP},{Mean_loss}\n")



# nohup python LocalGP_NInd.py > LocalGP_NIndout.log 2>&1 &