...
output_file = 'Result/DGP_preds_MSE_Ind.csv'


if not os.path.exists(output_file):
    with open(output_file, 'w') as f:
        f.write('Iteration,MSE_DGP,MSE_estimated_DGP\n')
...
for i in range(8,50):
    ...
    with open(output_file, 'a') as f:
        f.write(f"{i + 1},{MSE_DGP},{MSE_estimated_DGP}\n")



# nohup python DGP_Ind.py > DGP_Indout.log 2>&1 &