...
output_file = 'Result/NNLocalGP_preds_MSE_Ind.csv'


if not os.path.exists(output_file):
    with open(output_file, 'w') as f:
        f.write('Iteration,MSE_NNLocalGP,MSE_estimated_NNLocalGP\n')
...
for i in range(50):
    ...
    with open(output_file, 'a') as f:
        f.write(f"{i + 1},{MSE_NNLocalGP},{MSE_estimated_NNLocalGP}\n")



# nohup python NNLocalGP_Ind.py > NNLocalGP_Indout.log 2>&1 &